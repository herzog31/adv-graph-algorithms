...
Außerdem betrachten wir mehrere \textit{Matchingprobleme}. So findet der Algorithmus von Hopcroft und Karp kardinalitätsmaximale Matchings und mittels der Ungarischen Methode lassen sich perfekte Matchings optimalen Gewichts bestimmen. 
...
Grundlage unserer Implementierung ist ein Framework, welches im Zuge mehrerer Projekte entwickelt wurde. Es handelt sich um ein rein clientseitiges Web Framework zur Darstellung in modernen Webbrowsern. Es basierend auf HTML5 und modernen JavaScript Bibliotheken, sowie Cascading Stylesheets (CSS). Neben dem Framework selbst, konnten wir für unsere Implementierung auch auf den Programmcode verschiedener bereits implementierter Algorithmen zurückgreifen.
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/multigraph}
