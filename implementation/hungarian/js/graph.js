...
function GraphNode(coordinates,nodeID) {
    ...
    */
    ...
    /**
     * Gibt das äußere Label des Knotens zurück
     * @method
    ...
    /**
     * Setze das äußere Label des Knotens
     * @method
     * @param {String} newLabel Äußeres Label
     */
...
function Edge(sourceNode,targetNode,weight,edgeID,directedEdge) {
    ...
    /**
     * Überschreibe das Layout der Kante
     * @method
     * @param {Object} layoutObject Neues Layout
     */
    this.setLayoutObject = function(layoutObject) {
        layout = layoutObject;
    };
